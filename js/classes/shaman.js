...
window.CLASS_REGISTRY.shaman = {
  ...
  abilities: [
    { id: 'lightning_bolt', name: 'Descarga de Rayo', icon: '⚡',
      ...
      damageRanges: [
        { rank: 1, level: 1, min: 12, max: 18 },
        { rank: 2, level: 6, min: 24, max: 34 },
        { rank: 3, level: 12, min: 48, max: 62 },
        { rank: 4, level: 18, min: 84, max: 104 },
        { rank: 5, level: 24, min: 140, max: 172 },
      ] },
    ...
    { id: 'earth_shock', name: 'Choque de Tierra', icon: '🌍',
      ...
      damageRanges: [
        { rank: 1, level: 4, min: 10, max: 16 },
        { rank: 2, level: 10, min: 22, max: 32 },
        { rank: 3, level: 16, min: 44, max: 60 },
        { rank: 4, level: 22, min: 80, max: 104 },
      ] },
    ...
    { id: 'healing_wave', name: 'Ola de Sanación', icon: '🌊',
      ...
      damageRanges: [
        { rank: 1, level: 8, min: 32, max: 48 },
        { rank: 2, level: 14, min: 56, max: 80 },
        { rank: 3, level: 20, min: 92, max: 124 },
      ] },
    ...
    { id: 'lightning_shield', name: 'Escudo de Rayos', icon: '🛡️',
      ...
      damageRanges: [
        { rank: 1, level: 12, min: 15, max: 21 },
        { rank: 2, level: 18, min: 28, max: 38 },
        { rank: 3, level: 24, min: 48, max: 64 },
      ] },

    { id: 'flame_shock', name: 'Choque de Llamas', icon: '🔥',
      school: 'Naturaleza', type: 'damage', requiredLevel: 4,
      baseDamage: 20, spellPowerRatio: 0.214, costPct: 0.05, castType: 'instant', cooldown: 2,
      description: 'Quema al objetivo con llamas que causan daño prolongado.',
      damageRanges: [
        { rank: 1, level: 4, min: 8, max: 12 },
        { rank: 2, level: 10, min: 16, max: 24 },
        { rank: 3, level: 16, min: 32, max: 44 },
        { rank: 4, level: 22, min: 56, max: 74 },
      ],
      inflictsEffects: [
        { type: 'dot', name: 'Choque de Llamas', value: 10, duration: 3 },
      ] },

    { id: 'earth_shock_debuff', name: 'Choque Debilitador', icon: '📉',
      school: 'Naturaleza', type: 'damage', requiredLevel: 6,
      baseDamage: 15, spellPowerRatio: 0.143, costPct: 0.05, castType: 'instant', cooldown: 2,
      description: 'Reduce la armadura del objetivo.',
      damageRanges: [
        { rank: 1, level: 6, min: 6, max: 10 },
        { rank: 2, level: 12, min: 12, max: 18 },
        { rank: 3, level: 18, min: 24, max: 32 },
      ],
      inflictsEffects: [
        { type: 'debuff', name: 'Armadura Rota', stat: 'armor', value: 5, duration: 3 },
      ] },
  ],
};

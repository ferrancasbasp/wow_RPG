...
window.CLASS_REGISTRY.rogue = {
  ...
  abilities: [
    ...
    { id: 'ambush', name: 'Ambush', icon: '🗡️',
      ...
      generatesCombo: 2,
      damageRanges: [
        { rank: 1, level: 18, min: 85, max: 110 },
        { rank: 2, level: 26, min: 140, max: 175 },
    ...
    { id: 'garrote', name: 'Garrote', icon: '🩹',
      ...
      noWeaponScaling: true,
      damageRanges: [
        { rank: 1, level: 14, min: 16, max: 22 },
        { rank: 2, level: 22, min: 28, max: 36 },
        { rank: 3, level: 30, min: 44, max: 56 },
      ],
      inflictsEffects: [
      ...
      dotScales: true,
      dotRanges: [
        { rank: 1, level: 14, value: 22, duration: 6 },
        { rank: 2, level: 22, value: 36, duration: 6 },
    ...
    { id: 'backstab', name: 'Backstab', icon: '🔪',
      ...
      generatesCombo: 1,
      damageRanges: [
        { rank: 1, level: 4,  min: 22, max: 32 },
        { rank: 2, level: 10, min: 40, max: 54 },
        { rank: 3, level: 18, min: 70, max: 90 },
        { rank: 4, level: 26, min: 115, max: 145 },
    ...
    { id: 'poison_weapon', name: 'Veneno Mortal', icon: '🧪',
      ...
      buffRanks: [
        { rank: 1, level: 20, value: 8,  costEnergy: 0 },
        { rank: 2, level: 28, value: 16, costEnergy: 0 },
        { rank: 3, level: 36, value: 28, costEnergy: 0 },

...
window.CLASS_REGISTRY.druid = {
  ...
  formulas: {
    ...
    spellPower:  (s)      => Math.round(s.intelecto * 0.65 + s.espiritu * 0.1),
    attackPower: (s)      => 0,
  ...
  abilities: [
    ...
    { id: 'wrath', name: 'Wrath', icon: '☀️', iconImg: '',
      ...
      generatesCombo: 1,
      description: 'Lanza energía solar al objetivo. Genera 1 Fase Lunar.',
      damageRanges: [
        { rank: 1, level: 1,  min: 15, max: 20 },
        { rank: 2, level: 8,  min: 35, max: 45 },
    ...
    { id: 'moonfire', name: 'Moonfire', icon: '🌙', iconImg: '',
      ...
      isDot: true,
      dotDuration: 3,
      description: 'Quema al enemigo y le inflige daño durante 3 turnos. Genera 1 Fase Lunar.',
      damageRanges: [
        { rank: 1, level: 4,  min: 18, max: 22 },
        { rank: 2, level: 10, min: 30, max: 40 },
        { rank: 3, level: 16, min: 55, max: 65 },
      ],
      inflictsEffects: [
        { type: 'dot', name: 'Moonfire', value: 10, duration: 3 },
      ],
      dotScales: true,
      dotRanges: [
        { rank: 1, level: 4,  value: 10, duration: 3 },
        { rank: 2, level: 10, value: 18, duration: 3 },
    ...
    { id: 'starsurge', name: 'Starsurge', icon: '🌟', iconImg: '',
      ...
      description: 'Invoca el poder de las estrellas. Gasta todas las Fases Lunares. Más fases = más daño.',
      damageRanges: [
        { rank: 1, level: 10, min: 25, max: 35 },
        { rank: 2, level: 18, min: 50, max: 70 },
    ...
    { id: 'hurricane', name: 'Hurricane', icon: '🌪️', iconImg: '',
      ...
      spendsCombo: true,
      noWeaponScaling: true,
      description: 'Crea una tormenta en área. Gasta todas las Fases Lunares. Más fases = más daño.',
      damageRanges: [
        { rank: 1, level: 20, min: 60, max: 80 },
    ...
    { id: 'healing_touch', name: 'Healing Touch', icon: '🌿', iconImg: '',
      ...
      damageRanges: [
        { rank: 1, level: 1,  min: 40, max: 55 },
        { rank: 2, level: 8,  min: 90, max: 120 },
    ...
    { id: 'rejuvenation', name: 'Rejuvenation', icon: '🍃', iconImg: '',
      ...
      isHot: true,
      hotDuration: 4,
      description: 'Sana al objetivo durante 4 turnos. Aplicar manualmente en Efectos.',
      damageRanges: [
        { rank: 1, level: 6,  min: 100, max: 100 },
        { rank: 2, level: 12, min: 180, max: 180 },
    ...
    { id: 'entangling_roots', name: 'Entangling Roots', icon: '🌱', iconImg: '',
      ...
      buff: { stat: 'rooted', duration: 2, applySelf: false },
      buffRanks: [
        { rank: 1, level: 8,  value: 0, costPct: 0.06 },
        { rank: 2, level: 16, value: 0, costPct: 0.06 },
    ...
    { id: 'moonkin_form', name: 'Moonkin Form', icon: '🪶', iconImg: '',
      ...
      buff: { stat: 'moonkin', duration: 30, applySelf: true },
      buffRanks: [

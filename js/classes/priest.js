...
window.CLASS_REGISTRY.priest = {
  ...
  abilities: [
    ...
    { id: 'mind_blast', name: 'Mind Blast', icon: '💥',
      ...
      damageRanges: [
        { rank: 1, level: 10, min: 40, max: 54 },
        { rank: 2, level: 16, min: 68, max: 86 },
        { rank: 3, level: 22, min: 108, max: 132 },
        { rank: 4, level: 28, min: 164, max: 196 },
    ...
    { id: 'mind_spike', name: 'Mind Spike', icon: '🔮', iconImg: 'img/abilities/priest/mind_spike.jpg',
      ...
      damageRanges: [
        { rank: 1, level: 20, min: 56, max: 72 },
        { rank: 2, level: 26, min: 88, max: 110 },
        { rank: 3, level: 32, min: 130, max: 160 },
    ...
    { id: 'shadow_word_pain', name: 'Shadow Word: Pain', icon: '🩸', iconImg: 'img/abilities/priest/shadow_word_pain.jpg',
      ...
      dotDuration: 6,
      damageRanges: [
        { rank: 1, level: 4,  min: 60, max: 60 },
        { rank: 2, level: 10, min: 110, max: 110 },
        { rank: 3, level: 16, min: 180, max: 180 },
        { rank: 4, level: 22, min: 270, max: 270 },
    ...
    { id: 'flash_heal', name: 'Flash Heal', icon: '⚡', iconImg: 'img/abilities/priest/flash_heal.jpg',
      ...
      damageRanges: [
        { rank: 1, level: 14, min: 80, max: 100 },
        { rank: 2, level: 20, min: 130, max: 156 },
        { rank: 3, level: 26, min: 200, max: 236 },
    ...
    { id: 'greater_heal', name: 'Greater Heal', icon: '💚', iconImg: 'img/abilities/priest/heal.jpg',
      ...
      damageRanges: [
        { rank: 1, level: 16, min: 180, max: 220 },
        { rank: 2, level: 22, min: 280, max: 336 },
        { rank: 3, level: 28, min: 420, max: 500 },
        { rank: 4, level: 34, min: 600, max: 712 },
      ] },
  ],
};
